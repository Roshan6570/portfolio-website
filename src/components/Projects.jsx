...
const PROJECTS = [
  {
    title:       'Whanderlust',
    description: 'A full-stack travel and accommodation booking platform that allows users to explore destinations, manage listings, and make bookings through a secure and responsive web interface.',
    tags:        ['React', 'Node.js', 'MongoDB', 'Socket.io'],
    github:      'https://github.com/Roshan6570/whanderlust',
    demo:        'https://whanderlust.onrender.com/listings',
    emoji:       '🚀',
    featured:    true,
  },
  {
    title:       'video-streaming-app',
    description: 'A Video Streaming App is a web application that allows users to browse, search, and watch videos online seamlessly. It is built using React, Node.js, Express.js, and MongoDB to provide secure authentication, video management, and smooth playback across devices.',
    tags:        ['React', 'Node.js', 'MongoDB', 'Socket.io'],
    github:      'https://github.com/Roshan6570/video_call',
  ...
  },
  {
    ...
    description: 'A full-stack agricultural marketplace that connects farmers directly with buyers, enabling crop listings, price monitoring, secure authentication, and seamless online trading without intermediaries.',
